...
import com.ing.developer.greetings.auth.HttpBasicAuth;
import com.ing.developer.greetings.auth.HttpBearerAuth;
import com.ing.developer.greetings.auth.ApiKeyAuth;
import com.ing.developer.greetings.ApiResponseDecoder;

import com.ing.developer.greetings.auth.ApiErrorDecoder;
import com.ing.developer.greetings.auth.OAuth;
import com.ing.developer.greetings.auth.OAuth.AccessTokenListener;
import com.ing.developer.greetings.auth.OAuthFlow;
import com.ing.developer.greetings.auth.OauthPasswordGrant;
import com.ing.developer.greetings.auth.OauthClientCredentialsGrant;
...
public class ApiClient {
  ...
  private String basePath = "https://api.ing.com";
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("ING-Application-Security".equals(authName)) {
        auth = buildOauthRequestInterceptor(OAuthFlow.APPLICATION, "", "https://api.ing.com/oauth2/token", "greetings:view");
      } else {
