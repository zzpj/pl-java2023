...
import com.ing.developer.oauth2.auth.HttpBasicAuth;
import com.ing.developer.oauth2.auth.HttpBearerAuth;
import com.ing.developer.oauth2.auth.ApiKeyAuth;
import com.ing.developer.oauth2.ApiResponseDecoder;

import com.ing.developer.oauth2.auth.ApiErrorDecoder;
import com.ing.developer.oauth2.auth.OAuth;
import com.ing.developer.oauth2.auth.OAuth.AccessTokenListener;
import com.ing.developer.oauth2.auth.OAuthFlow;
import com.ing.developer.oauth2.auth.OauthPasswordGrant;
import com.ing.developer.oauth2.auth.OauthClientCredentialsGrant;
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("ING-Application-Security".equals(authName)) {
        auth = buildOauthRequestInterceptor(OAuthFlow.APPLICATION, "", "https://api.ing.com/oauth2/token", "granting");
      } else {
